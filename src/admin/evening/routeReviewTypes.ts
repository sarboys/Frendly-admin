...
export type RouteReviewContentItemListDto = {
  items: RouteReviewContentItemDto[];
  nextCursor: string | null;
};

export type RouteReviewGenerationRunDto = {
  id: string;
  city: string;
  timezone: string;
  area: string | null;
...
export type RouteReviewGenerationRunListDto = {
  items: RouteReviewGenerationRunDto[];
};

export type RouteReviewGenerationRunInput = {
  city: string;
  area?: string | null;
  mood: string;
  budget: string;
